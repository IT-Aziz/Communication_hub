 ...
 * private state doesn't leak into the shared global scope. Must load after admin-posts.js and
 * admin-categories.js (uses CH.openNewPostForm / CH.openNewCategoryForm).
 */
window.CH = window.CH || {};
